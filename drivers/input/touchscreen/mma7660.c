		...
		short x,short y,short z,u8 tilt)
{
	...
	if(rem_tilt) {
		unsigned char bTemp = 0,bTemp2 = 0;
		unsigned char bMask,bMask2,bTilt_org;
		...
		switch (mma_status.axis_dir_z) {
			...
			case AXIS_DIR_Z_N:
				...
				else if(0x08==(tilt&bMask2)) {
					bTemp2 = 0x14;
				}
				else if(0x14==(tilt&bMask2)) {
					bTemp2 = 0x08;
				}
				else if(0x18==(tilt&bMask2)) {
					bTemp2 = 0x04;
				}
				else {
					bTemp2 = tilt&bMask2;
